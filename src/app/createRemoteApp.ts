...
import type { TaskView, TasksProjectionState, CreateTaskOptions } from '../application/taskService.js'
import type { InteractionResponse } from '../application/interactionService.js'
import type { StoredEvent, UserInteractionRequestedPayload } from '../domain/events.js'
import type { StoredAuditEntry } from '../domain/ports/auditLog.js'
import { CoAuthorWsClient } from '../infra/remote/wsClient.js'
import { RemoteHttpClient } from '../infra/remote/httpClient.js'
import { RemoteEventStore } from '../infra/remote/remoteEventStore.js'
import { RemoteUiBus } from '../infra/remote/remoteUiBus.js'
