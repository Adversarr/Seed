      ...
      {loading ? (
        ...
        <div className="space-y-1">
          {[...events].reverse().map(evt => (
            <div key={evt.id} className="flex items-center gap-3 px-2 py-1.5 rounded hover:bg-zinc-800/50 transition-colors">
              ...
              <Link
                ...
                className="text-xs text-zinc-500 hover:text-violet-400 transition-colors font-mono truncate"
              >
                {evt.streamId}
              </Link>
            </div>
